...
with colText :
    with st.container(border=True, height=600):
        ...
        query = f"Berikan beberapa rekomendasi pilihan paket internet pada {selected_Product} di kecamatan {selected_kecamatan} desa {selected_desa} berdasarkan jumlah penduduk, pendidikan dan pekerjaan yang ada diwilayah tersebut, dan berikan alasannya"
